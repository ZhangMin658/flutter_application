...
class S {
  ...
  /// `Add more information for the restaurant`
  String get add_more_information_for_restaurant {
    return Intl.message(
      'Add more information for the restaurant',
      name: 'add_more_information_for_restaurant',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Select a Meal from the categories`
  ...
  /// `Click on the categories to get more details`
