...
Future<Stream<Category>> getCategoriesByRestID(resid) async {
  try {
    final String url = '${GlobalConfiguration().getString('api_base_url')}categoryByRest?resid=${resid.toString()}';
