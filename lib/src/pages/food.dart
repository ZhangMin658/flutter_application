...
class _FoodWidgetState extends StateMVC<FoodWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _con.food == null || _con.food?.image == null || _con.restaurant == null
                                    ...
                                    Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          _con.food.restaurant.isofferset ?
                                              Text(
                                                ' - 10%',
                                                style: Theme.of(context).textTheme.headline2,
                                              ):Container()
                                      ...
                                      child: FlatButton(
                                        onPressed: () {
                                          if (currentUser.value.apiToken == null) {
                                            ...
                                            double d_value = _con.restaurant.deliveryRange * 1000;
                                            print(_con.restaurant.distance);
                                            print(d_value);
                                            print(_con.restaurant.distance > d_value);
                                            if(_con.restaurant.distance > d_value){
                                              showDialog(
                                                  context: context,
                                                  builder: (context) => AlertDialog(
                                                    title: Text("Notification"),
                                                    content: Text("You are outside the delivery radius can buy here"),
                                                    actions: <Widget>[
                                                      FlatButton(
                                                        child: new Text(
                                                          S.of(context).close,
